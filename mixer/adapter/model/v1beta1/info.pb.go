...
type Info struct {
	...
	// [HandlerMetricService](https://github.com/istio/istio/blob/release-1.5/mixer/template/metric/template_handler_service.proto),
	// [HandlerListEntryService](https://github.com/istio/istio/blob/release-1.5/mixer/template/logentry/template_handler_service.proto),
	// [HandleQuotaService](https://github.com/istio/istio/blob/release-1.5/mixer/template/quota/template_handler_service.proto) and more).
